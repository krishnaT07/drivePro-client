...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        "premium": "0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04), 0 0 0 1px rgba(255, 255, 255, 0.05) inset",
        "premium-lg": "0 25px 50px -12px rgba(0, 0, 0, 0.25), 0 0 0 1px rgba(255, 255, 255, 0.05) inset",
        "glass": "0 8px 32px 0 rgba(31, 38, 135, 0.37)",
        "glow": "0 0 20px rgba(147, 51, 234, 0.5)",
        "glow-lg": "0 0 30px rgba(147, 51, 234, 0.8)",
      },
      backgroundImage: {
  ...
  plugins: [
    ...
    // Custom plugin for premium shadows
